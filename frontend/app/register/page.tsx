...
export default function RegisterPage() {
  useEffect(() => {
    ...
    const signupUrl = `${domain}/signup?client_id=${clientId}&response_type=code&scope=${scope}&redirect_uri=${encodeURIComponent(
      redirectUri
    )}`;
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-8 text-center shadow-xl">
      ...
      <h1 className="mt-3 text-2xl font-semibold text-white">Redirecting to sign up…</h1>
